...
We return to the affine-versus-linear distinction below
(Section~\ref{sec:affine-linear}).
...
\caption{The core type law $(E \otimes C) \multimap V$: an
  ...
  consumed ($\otimes$) to construct a \texttt{Verdict};
  compiler-enforced barriers block cloning, forging, and silent
  discarding of tokens.}
