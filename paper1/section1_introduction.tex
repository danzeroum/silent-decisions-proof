...
\caption{The silent-decision problem and the BTV response. Top: a
  consequential decision is emitted and its audit record, written
  asynchronously, may be lost. Middle: LGPD Art.~20 and EU AI Act
  Arts.~14 and~86 require review and explanation but do not by
  themselves prevent unevidenced decisions. Bottom: BTV makes evidence
  and an authority-signed compliance token preconditions of verdict
  construction.}
