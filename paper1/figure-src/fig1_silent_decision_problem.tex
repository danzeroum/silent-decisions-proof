...
\begin{tikzpicture}[
  ...
  panel/.style={draw=black!40, rounded corners=3pt, inner sep=5pt}
]

% ── Panel A: status quo ──────────────────────────────────────────────────
\node[box] (dec) {\textbf{Decision emitted}};
...
\node[panel, fit=(dec)(evd)(x)(xnote), label={[font=\scriptsize\bfseries, anchor=north west]north west:A. Status quo: runtime audit}] (p1) {};

% ── Panel B: BTV ──────────────────────────────────────────────────────────
\node[box, below=11mm of p1.south west, anchor=north west] (tokE)
  {\textbf{EvidenceToken}};
...
\node[panel, fit=(tokE)(tokC)(cons)(verd), label={[font=\scriptsize\bfseries, anchor=north west]north west:B. BTV: compile-time guarantee}] (p2) {};
