...
its correctness becomes a property that compilers can check, proof
assistants can verify, and regulators can audit through
\texttt{cargo test} rather than manual review.
