...
\emph{regulatory} obligations---the requirement that a decision act
with legal consequences cannot exist without a causally-bound,
non-repudiable evidence chain, as demanded by LGPD Art.~18\S2 and EU
AI Act Art.~86---and we scope the resulting guarantee to the Safe Rust
