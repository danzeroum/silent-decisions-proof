...
formation but inaccessible in its aftermath. This failure mode is not
hypothetical: off-channel communications fines levied by the U.S. Securities
and Exchange Commission since 2021 (exceeding \$2B in aggregate) demonstrate
that operators routinely fail to persist mandatory records even under explicit
regulatory obligations~\cite{sec-fines-2024}. The type \texttt{Verdict} proves
